...
export const ENEMY_TYPES = {
  rifleman: {
    id: 'rifleman', name: 'RIFLEMAN', style: 'legion', scale: 1.0, health: 80, armour: { chest: 30, head: 0 },
  ...
  breacher: {
    id: 'breacher', name: 'BREACHER', style: 'legion', scale: 1.05, health: 110, armour: { chest: 45, head: 0 },
  ...
  suppressor: {
    id: 'suppressor', name: 'SUPPRESSOR', style: 'legionHeavy', scale: 1.18, health: 250, armour: { chest: 90, head: 20 },
  ...
  grenadier: {
    id: 'grenadier', name: 'GRENADIER', style: 'legion', scale: 1.0, health: 85, armour: { chest: 30, head: 0 },
