...
const LINES = [
  ...
  // Operation: Black Lantern (Erebus colony city)
  ['voss_lantern_briefing', 'voss', 3, 'Vanguard, Erebus Colony has gone dark and loud at the same time. The Legion is broadcasting from our own towers. Relight it.'],
  ['voss_lantern_substation', 'voss', 3, 'The substation spire is feeding their signal. Overload it and the sky opens.'],
  ['voss_lantern_spire_down', 'voss', 3, 'Spire is down. Orbital support is yours. Now take the broadcast tower.'],
  ['voss_lantern_broadcast', 'voss', 3, 'The broadcast compound is ahead. Get into the control room and start the counter-broadcast.'],
  ['voss_lantern_reeducation', 'voss', 2, 'There is a re-education block on the west side. Two citizens are inside. Optional, but the paperwork is easier if they live.'],
  ['voss_lantern_upload', 'voss', 3, 'Upload started. Hold the control room until the city hears us.'],
  ['voss_lantern_rooftop', 'voss', 3, 'Rooftop pad, north-west. Get up there and call the ship.'],
  ['voss_lantern_complete', 'voss', 3, 'Erebus is relit. Every window in that city belongs to us again.'],
